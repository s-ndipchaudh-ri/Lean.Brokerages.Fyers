...
namespace QuantConnect.Brokerages.Fyers.Tests
{
    ...
    public class BrokerageAlgorithmSettings
    {
        ...
        private void ConfigSymbols()
        {
            ...
            else if (Markets.Contains("India"))
            {
                MarketSymbols = new IndiaMarketSymbols();
            }
        }
    ...
    public class DefaultMarketSymbols : BaseMarketSymbols
    {
        ...
        public override Symbol CryptoSymbol { get; set; } = Symbol.Create("BTCUSDT", SecurityType.Crypto, Market.Binance);
        public override Symbol CfdSymbol { get; set; } = Symbol.Create("XAUUSD", SecurityType.Cfd, Market.Oanda);
        public override Symbol CryptoFutureSymbol { get; set; } = Symbol.Create("BTCUSDT", SecurityType.CryptoFuture, Market.Binance);
    ...
    /// <summary>
    /// Market symbols for Indian markets (NSE, BSE)
    /// </summary>
    public class IndiaMarketSymbols : BaseMarketSymbols
    {
        public override Symbol EquitySymbol { get; set; } = Symbol.Create("SBIN", SecurityType.Equity, Market.India);
        public override Symbol CanonicalOptionSymbol { get; set; } = Symbol.Create("NIFTY", SecurityType.Option, Market.India);
        public override Symbol CanonicalIndexOptionSymbol { get; set; } = Symbol.Create("NIFTY", SecurityType.IndexOption, Market.India);
        public override Symbol CanonicalFutureSymbol { get; set; } = Symbol.Create("NIFTY", SecurityType.Future, Market.India);
    }
}
